...
public class PrivacyPolicyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String privacyPolicyString = "<h1>Privacy Policy</h1>\n" +
                "\n" +
                "\n" +
                "<p>Effective date: October 04, 2018</p>\n" +
                "\n" +
                "\n" +
                "<p>FindMyRoute (\"us\", \"we\", or \"our\") operates the  website and the FindMyRoute mobile application (the \"Service\").</p>\n" +
                "\n" +
                "<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for FindMyRoute is managed through <a href=\"https://www.freeprivacypolicy.com/free-privacy-policy-generator.php\">Free Privacy Policy</a>.</p>\n" +
                "\n" +
                ...
                "<h2>Use of Data</h2>\n" +
                "    \n" +
                "<p>FindMyRoute uses the collected data for various purposes:</p>    \n" +
                "<ul>\n" +
                ...
                "<p>FindMyRoute will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>\n" +
                "\n" +
                "<h2>Disclosure Of Data</h2>\n" +
                "\n" +
                "<h3>Legal Requirements</h3>\n" +
                "<p>FindMyRoute may disclose your Personal Data in the good faith belief that such action is necessary to:</p>\n" +
                "<ul>\n" +
                "    <li>To comply with a legal obligation</li>\n" +
                "    <li>To protect and defend the rights or property of FindMyRoute</li>\n" +
                ...
                "<ul>\n" +
                "        <li>By email: abhishekraj@abhishekraj.me</li>\n" +
                "          \n" +
                "        </ul>";
        TextView privacyPolicyTextView = findViewById(R.id.privacy_policy_text_view);
        privacyPolicyTextView.setText(Html.fromHtml(privacyPolicyString));
    }
